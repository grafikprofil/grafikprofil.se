...
return [
    ...
    'checksum' => '6f6988a9d0ad0c11af5b15faccdaeafa',
    'files' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.cookiespolicy.enabled' => [
                ...
                'name' => 'plugins.cookiespolicy.enabled',
                'validation' => 'strict'
            ],
            'plugins.cookiespolicy.type' => [
                'type' => 'select',
                'label' => 'Type',
                'size' => 'small',
                'default' => 'bar',
                ...
                'name' => 'plugins.cookiespolicy.type',
                'validation' => 'strict'
            ],
            'plugins.cookiespolicy.url' => [
                'type' => 'text',
                'label' => 'Privacy route',
                'size' => 'medium',
                'name' => 'plugins.cookiespolicy.url',
                'validation' => 'strict'
            ],
            'plugins.email' => [
                'form' => [
